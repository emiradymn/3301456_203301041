...
class Kreatin4Page extends StatefulWidget {

  String kreatin4Title;

  Kreatin4Page(this.kreatin4Title);

  @override
  State<Kreatin4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Kreatin4Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.kreatin4Title, context),
                            SizedBox(height: 32),
