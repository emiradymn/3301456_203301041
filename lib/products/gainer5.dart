...
class Gainer5Page extends StatefulWidget {

  String gainer5Title;

  Gainer5Page(this.gainer5Title);

  @override
  State<Gainer5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Gainer5Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.gainer5Title, context),
                            SizedBox(height: 32),
