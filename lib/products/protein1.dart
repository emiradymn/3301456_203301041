...
class Protein1Page extends StatefulWidget {

  String protein1Title;

  Protein1Page(this.protein1Title);

  @override
  State<Protein1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Protein1Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.protein1Title, context),
                            SizedBox(height: 32),
