...
class Kreatin1Page extends StatefulWidget {

  String kreatin1Title;

  Kreatin1Page(this.kreatin1Title);

  @override
  State<Kreatin1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Kreatin1Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.kreatin1Title, context),
                            SizedBox(height: 32),
