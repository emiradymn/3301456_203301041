...
class Shaker2Page extends StatefulWidget {

  String shaker2Title;

  Shaker2Page(this.shaker2Title);

  @override
  State<Shaker2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Shaker2Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.shaker2Title, context),
                            SizedBox(height: 32),
