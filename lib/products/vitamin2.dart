...
class Vitamin2Page extends StatefulWidget {

  String vitamin2Title;

  Vitamin2Page(this.vitamin2Title);

  @override
  State<Vitamin2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Vitamin2Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.vitamin2Title, context),
                            SizedBox(height: 32),
