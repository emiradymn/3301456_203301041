...
class Protein4Page extends StatefulWidget {

  String protein4Title;

  Protein4Page(this.protein4Title);

  @override
  State<Protein4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Protein4Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.protein4Title, context),
                            SizedBox(height: 32),
