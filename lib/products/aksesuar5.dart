...
class Aksesuar5Page extends StatefulWidget {

  String aksesuar5Title;

  Aksesuar5Page(this.aksesuar5Title);

  @override
  State<Aksesuar5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar5Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar5Title, context),
                            SizedBox(height: 32),
