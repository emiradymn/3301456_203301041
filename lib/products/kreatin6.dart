...
class Kreatin6Page extends StatefulWidget {

  String kreatin6Title;

  Kreatin6Page(this.kreatin6Title);

  @override
  State<Kreatin6Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Kreatin6Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.kreatin6Title, context),
                            SizedBox(height: 32),
