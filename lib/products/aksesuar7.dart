...
class Aksesuar7Page extends StatefulWidget {

  String aksesuar7Title;

  Aksesuar7Page(this.aksesuar7Title);

  @override
  State<Aksesuar7Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar7Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar7Title, context),
                            SizedBox(height: 32),
