...
class Kreatin2Page extends StatefulWidget {

  String kreatin2Title;

  Kreatin2Page(this.kreatin2Title);

  @override
  State<Kreatin2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Kreatin2Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.kreatin2Title, context),
                            SizedBox(height: 32),
