...
class Gainer4Page extends StatefulWidget {

  String gainer4Title;

  Gainer4Page(this.gainer4Title);

  @override
  State<Gainer4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Gainer4Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.gainer4Title, context),
                            SizedBox(height: 32),
