...
class Shaker3Page extends StatefulWidget {

  String shaker3Title;

  Shaker3Page(this.shaker3Title);

  @override
  State<Shaker3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Shaker3Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.shaker3Title, context),
                            SizedBox(height: 32),
