...
class Shaker4Page extends StatefulWidget {

  String shaker4Title;

  Shaker4Page(this.shaker4Title);

  @override
  State<Shaker4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Shaker4Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.shaker4Title, context),
                            SizedBox(height: 32),
