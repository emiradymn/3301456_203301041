...
class Aksesuar10Page extends StatefulWidget {

  String aksesuar10Title;

  Aksesuar10Page(this.aksesuar10Title);

  @override
  State<Aksesuar10Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar10Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar10Title, context),
                            SizedBox(height: 32),
