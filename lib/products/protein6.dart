...
class Protein6Page extends StatefulWidget {

  String protein6Title;

  Protein6Page(this.protein6Title);

  @override
  State<Protein6Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Protein6Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.protein6Title, context),
                            SizedBox(height: 32),
