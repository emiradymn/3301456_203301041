...
class Gainer6Page extends StatefulWidget {

  String gainer6Title;

  Gainer6Page(this.gainer6Title);

  @override
  State<Gainer6Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Gainer6Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.gainer6Title, context),
                            SizedBox(height: 32),
