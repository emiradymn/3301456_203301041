...
class Aksesuar9Page extends StatefulWidget {

  String aksesuar9Title;

  Aksesuar9Page(this.aksesuar9Title);

  @override
  State<Aksesuar9Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar9Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar9Title, context),
                            SizedBox(height: 32),
