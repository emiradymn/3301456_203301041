...
class Preworkout5Page extends StatefulWidget {

  String preworkout5Title;

  Preworkout5Page(this.preworkout5Title);

  @override
  State<Preworkout5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Preworkout5Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.preworkout5Title, context),
                            SizedBox(height: 32),
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    Center(child: Image.asset(
                                        "assets/images/preworkout5.jpeg")),
                                    ...
                                    Text("SHOT SAYISI", style: TextStyle(
