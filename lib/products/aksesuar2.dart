...
class Aksesuar2Page extends StatefulWidget {

  String aksesuar2Title;

  Aksesuar2Page(this.aksesuar2Title);

  @override
  State<Aksesuar2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar2Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar2Title, context),
                            SizedBox(height: 32),
