...
class Vitamin4Page extends StatefulWidget {

  String vitamin4Title;

  Vitamin4Page(this.vitamin4Title);

  @override
  State<Vitamin4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Vitamin4Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.vitamin4Title, context),
                            SizedBox(height: 32),
