...
class Vitamin6Page extends StatefulWidget {

  String vitamin6Title;

  Vitamin6Page(this.vitamin6Title);

  @override
  State<Vitamin6Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Vitamin6Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.vitamin6Title, context),
                            SizedBox(height: 32),
                              ...
                              child: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    Text("TABLET SAYISI", style: TextStyle(
