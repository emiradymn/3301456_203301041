...
class Aksesuar6Page extends StatefulWidget {

  String aksesuar6Title;

  Aksesuar6Page(this.aksesuar6Title);

  @override
  State<Aksesuar6Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar6Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar6Title, context),
                            SizedBox(height: 32),
