...
class Shaker1Page extends StatefulWidget {

  String shaker1Title;

  Shaker1Page(this.shaker1Title);

  @override
  State<Shaker1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Shaker1Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.shaker1Title, context),
                            SizedBox(height: 32),
