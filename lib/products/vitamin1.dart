...
class Vitamin1Page extends StatefulWidget {

  String vitamin1Title;

  Vitamin1Page(this.vitamin1Title);

  @override
  State<Vitamin1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Vitamin1Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.vitamin1Title, context),
                            SizedBox(height: 32),
