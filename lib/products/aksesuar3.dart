...
class Aksesuar3Page extends StatefulWidget {

  String aksesuar3Title;

  Aksesuar3Page(this.aksesuar3Title);

  @override
  State<Aksesuar3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar3Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar3Title, context),
                            SizedBox(height: 32),
