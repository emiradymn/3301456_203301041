...
class Aksesuar4Page extends StatefulWidget {

  String aksesuar4Title;

  Aksesuar4Page(this.aksesuar4Title);

  @override
  State<Aksesuar4Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar4Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar4Title, context),
                            SizedBox(height: 32),
