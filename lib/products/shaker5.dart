...
class Shaker5Page extends StatefulWidget {

  String shaker5Title;

  Shaker5Page(this.shaker5Title);

  @override
  State<Shaker5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Shaker5Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.shaker5Title, context),
                            SizedBox(height: 32),
