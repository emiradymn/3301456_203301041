...
class Gainer2Page extends StatefulWidget {

  String gainer2Title;

  Gainer2Page(this.gainer2Title);

  @override
  State<Gainer2Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Gainer2Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.gainer2Title, context),
                            SizedBox(height: 32),
