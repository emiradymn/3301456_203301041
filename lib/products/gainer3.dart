...
class Gainer3Page extends StatefulWidget {

  String gainer3Title;

  Gainer3Page(this.gainer3Title);

  @override
  State<Gainer3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Gainer3Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.gainer3Title, context),
                            SizedBox(height: 32),
