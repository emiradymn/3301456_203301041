...
class Vitamin3Page extends StatefulWidget {

  String vitamin3Title;

  Vitamin3Page(this.vitamin3Title);

  @override
  State<Vitamin3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Vitamin3Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.vitamin3Title, context),
                            SizedBox(height: 32),
