...
class Kreatin3Page extends StatefulWidget {

  String kreatin3Title;

  Kreatin3Page(this.kreatin3Title);

  @override
  State<Kreatin3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Kreatin3Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.kreatin3Title, context),
                            SizedBox(height: 32),
