...
class Shaker6Page extends StatefulWidget {

  String shaker6Title;

  Shaker6Page(this.shaker6Title);

  @override
  State<Shaker6Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Shaker6Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.shaker6Title, context),
                            SizedBox(height: 32),
