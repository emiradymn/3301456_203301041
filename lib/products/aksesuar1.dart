...
class Aksesuar1Page extends StatefulWidget {

  String aksesuar1Title;

  Aksesuar1Page(this.aksesuar1Title);

  @override
  State<Aksesuar1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar1Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar1Title, context),
                            SizedBox(height: 32),
