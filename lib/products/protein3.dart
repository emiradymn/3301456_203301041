...
class Protein3Page extends StatefulWidget {

  String protein3Title;

  Protein3Page(this.protein3Title);

  @override
  State<Protein3Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Protein3Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.protein3Title, context),
                            SizedBox(height: 32),
