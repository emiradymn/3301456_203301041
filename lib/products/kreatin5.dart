...
class Kreatin5Page extends StatefulWidget {

  String kreatin5Title;

  Kreatin5Page(this.kreatin5Title);

  @override
  State<Kreatin5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Kreatin5Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.kreatin5Title, context),
                            SizedBox(height: 32),
