...
class Gainer1Page extends StatefulWidget {

  String gainer1Title;

  Gainer1Page(this.gainer1Title);

  @override
  State<Gainer1Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Gainer1Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.gainer1Title, context),
                            SizedBox(height: 32),
