...
class Aksesuar8Page extends StatefulWidget {

  String aksesuar8Title;

  Aksesuar8Page(this.aksesuar8Title);

  @override
  State<Aksesuar8Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Aksesuar8Page> {
  Color selectedColor =Color(0xFFB64D00);
  String selectedkilo = "M";
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.aksesuar8Title, context),
                            SizedBox(height: 32),
