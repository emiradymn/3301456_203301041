...
class Protein5Page extends StatefulWidget {

  String protein5Title;

  Protein5Page(this.protein5Title);

  @override
  State<Protein5Page> createState() => _ProductDetailPageState();
}
class _ProductDetailPageState extends State<Protein5Page> {
                ...
                children: [
                  Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            //HEADER
                            header(widget.protein5Title, context),
                            SizedBox(height: 32),
